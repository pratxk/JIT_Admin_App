...
import com.example.jitadminapp.NoticeData;
import com.example.jitadminapp.R;
import com.example.jitadminapp.UploadNotice;
...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[]{"Select Category","Computer Science","Electronics & Telecommunication","Electrical","Mechanical"};
